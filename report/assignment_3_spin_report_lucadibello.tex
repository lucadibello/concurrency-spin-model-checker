...
\end{minipage}\hfill
\begin{minipage}[t]{0.45\textwidth}
	\begin{lstlisting}[language=Promela, caption={ProMeLa parallel worker implementation leveraging processes}, captionpos=b, breaklines=true, label={lst:promela_parallel_worker}]
...
\subsection{Parameters: MAX and LENGTHf}
